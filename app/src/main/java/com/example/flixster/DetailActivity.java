...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY = "AIzaSyCUW5rgQbv3HPXH9kAVadTi5C-S4BxhQeY";
    ...
    private void initializeYoutube(String youtubeKey,double movieRating) {
